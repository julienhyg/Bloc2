...
Ainsi, après la prise de connaissance du portefeuille de projets choisis par la DSI, nous avons soigneusement recueillis et classé les informations par projet comme suit :
...
| Dév. mobile fournisseurs 	| Février 	| 200K 	| 8 Mois 	| 250 	| 5 	| 5 	| 2 	|
| MàJ outil de paie 	| Juin 	| 50K 	| 3 Mois 	| 50 	| 5 	| 1 	| 4 	|
| Installation client de messagerie 	| Avril 	| 50K 	| 2 Mois 	| 50 	| 2 	| 2 	| 3 	|
| MeP outil de cyber sécurité 	| Janvier 	| 250K 	| 2 Mois 	| 220 	| 5 	| 2 	| 3 	|
| Màj site web 	| Février 	| 300K 	| 3 Mois 	| 400 	| 5 	| 4 	| 2 	|
Table: Présentation des projets. [^4]

[^4]: MeP - Mise en Place ; MàJ - Mise à jour ; Dev. - Développement

Puis, d’après les informations dont nous disposions et en s’appuyant sur la vision de l’entreprise, nous avons dégagé des indicateurs mesurables de points stratégiques.  
...
|---	|:---:	|:---:	|:---:	|:---:	|:---:	|:---:	|:---:	|
| Valeur ajoutée clients 	| 5 	| 4 	| 2 	| 2 	| 1 	| 3 	| 4 	|
...
Cette première modélisation radar nous a permis d’extraire une première grille de priorisation :  
 ...
 5. Ex Aequo : **Mise à jour outil de paie** et **mise en place d’un outil de cyber sécurité**
...
En effet, afin d’obtenir une grille de priorisation plus réaliste et complète, nous avons également pris en compte les contraintes inhérentes aux obligations et valeurs de l’entreprises.  
...
Les projets 4 de mise à jour réglementaire des outils de paie 6 de mise en place d’un outil de cyber sécurité comportent ce type d’obligation.  
...
Ainsi, en multipliant ces critères règlementaires par 2, nous obtenons une nouvelle priorisation du portefeuille de projets :  
 ...
 1. **Mise en place d’un outil de cyber sécurité**
...
|  	| Projet1 	| Projet2 	| Projet3 	| Projet4 	| Projet5 	| Projet6 	| Projet7 	|
|---	|:---:	|:---:	|:---:	|:---:	|:---:	|:---:	|:---:	|
| Valeur ajoutée clients 	| 5 	| 5 	| 2 	| 2 	| 1 	| 3 	| 4 	|
...
En outre, le parlement européen oblige à prendre des mesures minimales en termes de cybersécurité (article 32 et article 5) et des sanctions administratives et pénales (article 83) pour les entreprises qui ne respectent pas les obligations de la *RGPD* (*Règlement Général de Protection des Données*).  
...
En résumé, cette directive vise à renforcer et élargir l’exigence règlementaire pour la cyber sécurité aux entreprises allant des PME au groupes du CAC40.  
Dans un contexte européen et géopolitique où les attaques cyber sont un enjeu majeur pour la souveraineté et la sécurité des données, les entreprises engagés dans les services numériques se doivent de se mettre en conformité.  

### Contraintes éthiques

Bien que les contraintes règlementaires pour la cyber sécurité et la mise en conformité des outils de gestion de paie soient fortes, il restait un dernier point à prendre en compte dans notre grille de priorisation stratégique : le facteur éthique.  
...
A l’ajout de ces contraintes dans nos tableaux de priorisation, nous avons constaté un manque de lisibilité des diagrammes radars. En effet, la mise en perspectives de projets avec et sans contraintes rend inutilisable ce type de graphique.  
...
En conclusions, la grille de priorisation stratégique finale est :
 ...
 2. Projet 6 : **Mise en place d’un outil de cyber sécurité**
...
Afin de s’adapter aux potentiels changements du marché ainsi qu’aux habitudes des utilisateurs qui peuvent rapidement évoluer, nous avons répondu à la demande de la direction en réalisant en parallèle une grille de priorisation calquée uniquement sur des critères de rentabilité.  
...
Nous avons ainsi dans l'ordre :
 ...
 2. A égalité **projet 2** et **projet 4** (développement mobile pour les clients et mise à jour réglementaire des outils de paie)
 3. **Projet 3** et **projet 6** (développement mobile pour les fournisseurs et mise en place d’un outil de cyber sécurité)
...
![Histogramme de priorisation de rentablité sans risques](ASSETS/IMAGES/4/3_histogramme_priorisation_rentabilite_sans_risques.PNG){width=67%}
...
Au final, nous obtenons l’ordre suivant :
 ...
 1. Projet 5 : **Installation d’un client de messagerie instantanée open source** 
 2. Projet 4 : **Mise à jour réglementaire des outils de paie**
 3. Projet 2 : **Développement mobile pour les clients** 
 4. Projet 6 : **Mise en place d’un outil de cyber sécurité** 
...
#   Réponses aux questions
 ...
 >  En quoi le fait de disposer d’un tableau d’alignement des projets avec la stratégie de l’entreprise est important ?

En définissant une stratégie, l’entreprise choisi une direction sur le moyen et long terme en ce qui concerne la politique interne, l’économie et le management de ses équipes. 
...
C’est pourquoi la mise à disposition d’un tableau d’alignement calqué sur la stratégie de l’entreprise est crucial puisqu’il permet de s’aligner sur les contours de cette stratégie en gardant la bonne direction.  

Ce tableau permet de disposer d’une vue d’ensemble des projets et de leur impact sur la stratégie. 
Il permet ainsi une optimisation des priorisations, une gestion optimale de la temporalité sur l’avancement et une meilleure répartitions des ressources matérielles et humaines. 

D’autres part, en étant le fruit de la stratégie, les projets deviennent également la vitrine de cette stratégie et donc participent à sa réussite. 
...
Une décision de s’engager dans un projet non rentable peut avoir des répercussions néfastes sur sa croissance mais à contrario, des projets rentables contribuent à saisir de nouvelles opportunités de croissance.
...
En effet, les critères stratégiques pouvant être des critères d’engagements éthiques ou de vision subjectives de l’entreprises, il faut qu’ils soient modérés par des indicateurs objectifs. 
La rentabilité est quantifiable dans le temps et peut-être calculée au fur et à mesure là ou un critère stratégique sera plus dur à évaluer comme l’aspect éthique par exemple. 
...
Dans un autre registre, nous pouvons également citer en exemple la mise en place d’outils de cyber sécurité qui figure parmi les mauvais élèves en termes de rentabilité. Pourtant, ce projet est essentiel pour la protection et la sécurité des données aussi bien d’un point de vue légal qu’éthique. Il doit donc être considéré dans sa globalité avec une prise en compte de contraintes règlementaires et de risques futurs.
...
En outre, l’expansion et la conquête de nouveaux marchés nécessitent parfois des investissements sur le long terme. Pas forcément rentable à première vue, cette mobilisation financière peut pourtant avoir des répercussions très positives sur le développement future de l’entreprise. 
...
A la fois variés et transverses du point de vue du système d’informations, ces projets s’inscrivent globalement dans une démarche semblable à la vision stratégique de l’entreprise. 
Néanmoins, de par leurs disparités en termes de durée, de budget et de contraintes, ces projets ne peuvent être prioriser facilement au premier abord. 
...
Problèmes rencontrés : certains problèmes peuvent être bloquant ou révélateurs de futurs points bloquants. 
...
En résumé, malgré le caractère complet des projets du portefeuille, le service PMO que nous sommes doit extraire davantage d’informations sur les parties prenantes, le périmètre, les retours sur investissements et la gestion des risques afin d’optimiser le suivi des projets. 
Ces informations délivrées tous les mois à la direction sous la forme de compte rendus permettent de poser un diagnostic pour aider à la prise de décisions et de réaliser une amélioration continue de gestion du portefeuille grâce à des indicateurs de performances plus complets.